      ...
      <div className="max-w-md w-full mx-auto px-6">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 glass-morphism p-8 transform transition-all duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Join LOKESH Sports Arena</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              <input 
                ...
                onChange={handleInputChange}
                className="w-4 h-4 text-primary bg-white/10 border-white/20 rounded focus:ring-primary focus:ring-2 mt-1"
              />
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/login" className="text-primary hover:text-blue-400 font-medium transition-colors ml-1">
                Sign in here
              </Link>
            </p>
          </div>
